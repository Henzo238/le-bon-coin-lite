...
const stripePromise = loadStripe(
  'pk_test_51QO1WEEzcVsatfhVFZFVTWsBePEsCNzteNT21nBRdNGB9m0vedM32R0SyHZMkhnFx7kbNLvjUyIDnUyetIP1E2p900W4n3Prxs',
)
  ...
  <main>
    <div class="container">
      ...
      <div class="columns">
        <div class="firstCol">
          <form @submit.prevent="handlePayment">
            <div>
              ...
              <p>
                Une pièce d’identité vous sera demandée pour récupérer votre
                colis.
              </p>
              ...
              <p>
                Recevoir un SMS pour l’arrivée de votre colis ou votre code de
                locker
              </p>
            </div>

            <p>
              Vous ne serez débité que lorsque le vendeur aura confirmé la
            ...
            <div>
              ...
              <p>
                Paiement sécurisé Votre banque peut vous demander d’autoriser le
        ...
        <div class="container" v-if="!offerInfos.attributes">
          Chargement en cours...
        </div>
          ...
          <div class="optionsPart">
            ...
            <div>
              ...
              <label for="faceToFace">
                ...
                <p class="smallText">
                  Payez en ligne et récupérez votre achat en main
                </p>

                <p class="smallText">
                  propre lors de votre rendez-vous avec le vendeur
                </p>
              </label>
            </div>
